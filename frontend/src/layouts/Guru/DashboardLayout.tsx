      ...
      <main className="p-5 md:p-[26px_34px_60px]">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-[26px] gap-5">
          <div className="flex flex-col gap-1.5">
            {/* Badge Tanggal yang Lebih Menarik */}
            <div className="inline-flex items-center gap-2 self-start px-3 py-1 bg-[#FFFDF8] border border-[#E3DACB] rounded-full text-[12.5px] font-medium text-[#6B7080] shadow-[0_1px_2px_rgba(30,25,15,0.02)]">
              <svg className="w-3.5 h-3.5 text-[#B98A3E]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <button className="w-[38px] h-[38px] flex items-center justify-center bg-[#FFFDF8] border border-[#E3DACB] rounded-[10px] relative text-[#23283A] shrink-0 cursor-pointer shadow-sm hover:bg-[#FAF6EC] transition-colors">
