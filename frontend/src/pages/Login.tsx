...
export default function Login() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center text-[#23283A] p-7 font-['Plus_Jakarta_Sans',sans-serif] antialiased animate-fade-only overflow-hidden">
      ...
      {/* ===== LOGIN CARD ===== */}
      <div className="relative z-10 w-full max-w-[1040px] min-h-[640px] bg-[#FFFDF8] rounded-[22px] overflow-hidden grid grid-cols-1 md:grid-cols-[0.85fr_1.15fr] shadow-[0_1px_2px_rgba(30,25,15,0.04),0_20px_44px_-20px_rgba(20,17,10,0.28)]">
        ...
        >
          ...
          <div className="max-w-[340px] relative z-10">
            ...
            <p className="text-[14px] text-[#E0E6F5] mt-[14px] leading-[1.6]">
              Mewujudkan pembelajaran yang lebih teratur, praktis, dan
              terhubung dengan memudahkan guru dan siswa mengelola
              berbagai aktivitas pembelajaran secara digital, kapan
          ...
          <div className="grid grid-cols-3 gap-3 border-t border-white/20 pt-5 text-center relative z-10">
            <div>
              <div className="font-['Fraunces',serif] font-bold text-[18px] text-white">
                1
              </div>

              <div className="text-[11px] text-[#D0D9EE] mt-0.5">
                Guru aktif
              </div>
            </div>
        ...
        <div className="flex flex-col justify-center p-9 md:p-[40px_46px_32px]">
          ...
          <form onSubmit={handleLogin}>
            <div className="mb-4">
              ...
              <div className="flex items-center gap-[9px] border border-[#E3DACB] rounded-[10px] px-3 bg-[#FFFDF8] focus-within:border-[#2C3B5E] transition-all">
                <svg
                  className="text-[#9C9582] shrink-0"
                  width="16"
                  height="16"
                  viewBox="0 0 24 24"
                  fill="none"
            ...
            <div className="flex items-center justify-between text-[13px] mb-5">
              <label className="flex items-center gap-2 cursor-pointer text-[#6B7080]">
                <input
                  ...
                  className="w-[15px] h-[15px] accent-[#1E2A47]"
                />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#1E2A47] text-white border-none rounded-[10px] py-3 text-[14.5px] font-bold flex items-center justify-center gap-2 hover:bg-[#141C30] disabled:opacity-50 cursor-pointer shadow-md"
            >
          ...
          <div className="relative text-center my-5">
            <span className="bg-[#FFFDF8] px-3 text-[12px] text-[#9C9582] relative z-10">
              atau
            </span>

            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-[#E3DACB]"></div>
            </div>
          </div>

          <Link
            to="/register"
            className="w-full bg-transparent text-[#1E2A47] border border-[#E3DACB] rounded-[10px] py-[11px] text-[14px] font-semibold flex items-center justify-center gap-2 hover:bg-[#F9F6EE] transition-all no-underline"
          >
            ...
            <svg
              ...
              strokeWidth="2"
            >
              <path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0 4-4V7a4 4 0 0 0-4-4" />
          ...
          <div className="text-[11.5px] text-[#9C9582] text-center mt-5 leading-[1.5]">
            Belum bisa masuk? Hubungi admin tata usaha sekolah untuk
            bantuan akun.
          </div>
        </div>
      </div>
